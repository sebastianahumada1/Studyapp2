...
import { useCreateSubtopic } from '@/hooks/useKnowledgeHub';
...
export function CreateSubtopicModal({ topicId, onClose }: CreateSubtopicModalProps) {
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-white mb-6 pr-10">Agregar Subtema</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-white text-sm font-medium mb-2">Nombre del Subtema</label>
            <input
              type="text"
              value={name}
          ...
          <div className="flex gap-4 justify-end pt-4">
            ...
            >
              {createSubtopic.isPending ? 'Creando...' : 'Crear Subtema'}
            </button>
          </div>
        </form>
      </div>
